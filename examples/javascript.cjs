...
// Plain JavaScript (CommonJS) example.
// For ESM use: import { VizIoTMQTT } from 'viziot-mqtt-client-nodejs';
// For TypeScript see examples/typescript.ts — the API is identical.
